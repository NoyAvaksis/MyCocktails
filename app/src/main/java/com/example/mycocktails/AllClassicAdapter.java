...
public class AllClassicAdapter extends RecyclerView.Adapter<AllClassicAdapter.MiniPostHolder> implements RecyclerView.OnItemTouchListener {

    public ArrayList<Cocktail> mList;
    private final Context context;

    public AllClassicAdapter(Context context, ArrayList<Cocktail> mList) {
    ...
    public MiniPostHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.classic_cocktail_list_item, parent, false);
