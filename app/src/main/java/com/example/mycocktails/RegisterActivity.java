                    ...
                    user.updateProfile(profileChangeRequest).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                ...
                                finish();
                            } else Toast.makeText(RegisterActivity.this,"dont work",Toast.LENGTH_LONG).show();
                        }
                    });
                } else Toast.makeText(RegisterActivity.this,"dont work",Toast.LENGTH_LONG).show();
            }
        });
        else Toast.makeText(RegisterActivity.this,"Enter All Data!",Toast.LENGTH_LONG).show();
    }
    public void login() {
        if(!isThereEmptyData())
